-- =====================
-- CAPTAIN STAR DASHBOARD - CLEAN DATABASE SCHEMA
-- =====================
...
DROP VIEW IF EXISTS public.team_statistics CASCADE;
DROP VIEW IF EXISTS public.client_statistics CASCADE;
...
-- =====================
-- STEP 2: CREATE TABLES (in correct order - parents first)
-- =====================
...
CREATE INDEX idx_users_team_role ON public.users(team_role);

-- 2. CLIENTS TABLE (no foreign keys)
...
-- 3. CLIENT ACCOUNTS TABLE (depends on clients)
...
-- 4. PROJECTS TABLE (depends on clients and users)
